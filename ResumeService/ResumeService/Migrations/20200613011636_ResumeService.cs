...
{
    public partial class ResumeService : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityAuthenticated = table.Column<bool>(nullable: true),
                    IdentityAuthenticationType = table.Column<string>(nullable: true),
                    RemoteIP = table.Column<string>(nullable: true),
                    RemotePort = table.Column<int>(nullable: true),
                    ClientCertificateThumbprint = table.Column<string>(nullable: true),
                    ClientCertificateSubject = table.Column<string>(nullable: true),
                    ClientCertificateIssuer = table.Column<string>(nullable: true),
                    CreationDate = table.Column<DateTime>(nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResumeServiceVisitors", x => x.TransactionID);
                });
